...
export default function ClientDisputesPage() {
  ...
  const fetchDisputes = async () => {
    ...
    try {
      const response = await disputesAPI.getClientDisputes();
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <Button
          onClick={() => router.push('/client/create-dispute')}
          className="bg-red-600 hover:bg-red-700 text-white rounded-md flex items-center"
        >
